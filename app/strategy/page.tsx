...
const briefs = [
  {
    ...
    title:   'Escape Routes',
    blurb:   "Getting outside shouldn't feel like a second job. We ran a Recollective audience study with BU undergrads to make Dick's thier city escape plan.",
  ...
  },
  {
    ...
    blurb:   "As a bleeding heart brand Liquid Death hijack's valentines day the only way it could, with a rock start blood drive.",
  ...
  },
  {
    ...
    blurb:   "The true crime community uncover the morbid to seek justice and understanding. We found out why Rold Gold needs to be the snack thier gut trusts.",
